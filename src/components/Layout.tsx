...
export function Layout({ children, user, activeTab, setActiveTab, onSignOut }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] pb-24 font-serif">
      ...
      <header className="bg-white border-b border-[#5A5A40]/10 px-6 py-4 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-[#1a1a1a]">AfyaScan</h1>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="text-right hidden sm:block">
              <p className="text-sm font-medium text-[#1a1a1a]">{user.displayName}</p>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#5A5A40]/10 px-6 py-4 z-10">
